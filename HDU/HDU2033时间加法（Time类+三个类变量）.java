...
class Time{
    ...
    public void timeAdd(Time t){
        int carry = 0;
        carry = (this.second + t.second) / 60;
        this.second = this.second + t.second - carry * 60;
        carry = (this.minute + t.minute + carry) / 60;
        this.minute = this.minute + t.minute - carry * 60;
        this.hour = this.hour + t.hour + carry;
    }
